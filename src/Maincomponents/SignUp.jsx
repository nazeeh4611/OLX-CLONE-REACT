...
import { validateSignup } from '../utilities/SignUp';
...
function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    const validationError = validateSignup(email,username,password,mobile);
    if (validationError) {
    ...
    try {
      ...
      await signup(email, username, password, mobile);
      navigate('/login');
    } catch (error) {
  ...
  return (
    <>
      <Navbar />
      <div className='signupform bg-gray-100 flex items-center justify-center min-h-screen'>
